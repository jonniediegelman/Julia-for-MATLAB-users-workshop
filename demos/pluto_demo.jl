...
# ╔═╡ b5c086d6-dc59-11ec-36b2-5ba8e952ca45
begin
	using Plots
	import Plotly
	using PlutoUI
...
# ╔═╡ 85c90ac0-221c-43a6-91f1-8654772d067c
t = 0:0.01:50

# ╔═╡ dd37da9b-5eee-46f0-bba2-58a66541c4f7
x = sin.(t) .+ randn(length(t))

# ╔═╡ eb269a51-b55e-411e-8499-57ea2acf8918
@bind n Slider(5:100, show_value=true)

# ╔═╡ fe65660a-9985-4364-96c2-eac9dd65ee93
x̄ = [sum(x[i-n:i])/n for i in 1+n:length(x)]

# ╔═╡ 0cb5fda5-917c-4d06-8087-3c17f7bdd861
begin
	plot(t, x; label="x")
	plot!(t, sin; label="sin(x)", linewidth=2, color=:goldenrod)
	plot!(t[1+n:end], x̄; label="x̄", linewidth=1, color=:red)
end
